...
func (s *Sqlite) CreateStudent(name string, email string, age int) (int64, error) { //overriding/implementing the interface
...
func (s *Sqlite) GetStudentById(id int64) (types.Student, error) {
	...
	// serialize the data coming from stmt above and put it into the stuct
